export const Modal = ({
  ...
  const formatNombre = (username) => {
    const newName = username.slice(1).slice(0, -1);
    return newName;
  };
  ...
  return (
    <div
      ...
      } flex-col justify-center items-center gap-7 bg-black absolute w-auto h-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40 rounded-lg px-10 pb-10`}
    >
      <svg
      ...
      <h1 className="text-white uppercase text-3xl font-bold tracking-wider text-center">
        Felicidades {formatNombre(name)} ¡Ganaste!
      </h1>
